...
class ZeroWidthStore(private val coroutineScope: CoroutineScope) : Store<ZeroWidthState, ZeroWidthIntent, ZeroWidthEffect> {
    ...
    private fun encodeText() {
        ...
        // Use less visible zero-width characters: Zero Width Joiner = U+200D, Word Joiner = U+2060
        val zws = '\u200D'
        val zwnj = '\u2060'
        ...
        val hiddenString = binarySecret.map { if (it == '1') zws else zwnj }.joinToString("")
    ...
    private fun decodeText() {
        ...
        for (char in encodedText) {
            if (char == zws) binaryBuilder.append('1')
        ...
        try {
            ...
            val decodedSecret = String(bytes, Charsets.UTF_8)
